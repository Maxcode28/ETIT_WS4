...
Quelltext in anderen Formaten, z. B. \LaTeX- oder C-Code, kann ebenfalls mit dem Befehl \verb|\lstinputlisting| eingebunden werden. Legen Sie dazu die \verb|.c|-Datei in den Vorlagenordner und geben Sie folgenden Befehl ein.
\begin{verbatim}
\lstinputlisting[caption={Einbinden von C-Code.},language=c++]
{Beispiel.c}
\end{verbatim}
Der gezeigte Befehl erzeugt dann Quellcode~\ref{lst:Beispiel_C}.
\lstinputlisting[caption={Einbinden von C-Code.},label=lst:Beispiel_C,language=c++]{Beispiel.c}